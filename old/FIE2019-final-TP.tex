...
Is teaching cybersecurity different? Lecturing is probably not the best way. Should we use real-life case studies (e.g. British Airways \cite{Barth2018a}).  % JHD - need's fixing.

%AI noted the workshops with ISC$^2$, with the ``this is a fad'' concept.  {\bf AI to write up}.
  This raises pedagogic questions which are beyond the scope of this research to resolve. Should we be teaching content because it's underpinning?; or because there's a skill shortage?  
...
\subsection{An industry example - PCI DSS}\label{sec:PCIDSS}
