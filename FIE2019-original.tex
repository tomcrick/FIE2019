...
However, ``Privacy by Design'' is no good without ``Security by Implementation'', and many security weaknesses are implementation weaknesses.
...
\begin{itemize}
	\item teach SQL without teaching SQL Injection (\cite{Drop2019} and the second author's experience);
