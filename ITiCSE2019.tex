...
Specialist curricula abound: a recent one is \cite{ACM2017b}. However, given the shortage of specialists, in practice a good generalist with some CYberSecurity expertise can often get a ``specialist''.
