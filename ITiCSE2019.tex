...
In the world of software and systems development, we have seen the disruption of Agile and DevOps, but not necessarily through the lens of security; however, more recently there has been a recogition of the need for change, exemplified by the emergence of ``DevSecOps''. If security is not to be left to the experts, then the generalist must know about it. Thus, in the context of widespread international computer science curriculum reform -- both in compulsory, as well as post-compulsory education -- what does this trend mean more generally for institutions and educators, and how do we teach it? 
