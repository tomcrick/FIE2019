% JHD to
% a) Add the Bonn work
% b) Add ABET stuff and ask Tom P to cross-check.
...
The Payments Industy \cite[6.6]{PCI2018b} insists on either independent code reviews by security specialists or a Web Application Firewall: essentially saying that the normal development process even after developers are trained in secore coding practices \cite[6.5]{PCI2018b} cannot be trusted to deliver secure code.
