...
\title{Cybersecurity Education and Accreditation:\\A Case Study of the UK}
...
We demonstrate the positive effect that accreditation requirements can have, and give some recommendations both for research and for curriculum developments.
...
\end{quote}
\noindent
These global cybersecurity crises have compelled academic institutions to address the demand for educated cybersecurity professionals~\cite{McGettrick2013}. As no shared framework for ``cybersecurity'' as an academic discipline exists, growth has been unfocused and driven by training materials, which make it harder to create a common body of knowledge (\cite{Bristol2019a} is still a work in progress). An international perspective is still harder, as different nations use different criteria to define local needs~\cite{schneider2013}. As a result, new programmes entering this space are on their own to conceptualise, design, package and market their programs, as there is no globally accepted reference model for cybersecurity to allow employers or students to understand the extent of a given cybersecurity program~\cite{conklin-et-al:2014,Parrishetal2018a}.
