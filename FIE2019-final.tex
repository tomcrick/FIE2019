...
The UK's official body of knowledge resource, the CyBOK project\cite{Bristol2019a}, has produced reference documentation for some (5  final, 7 for comment out of a planned total of 19)   % JHD updated figures 21/6/2019
...
departments in the USA. % (using \cite{StangerMartin2015a}'s list, the other six didn't have a book listed). 
...
\section{Accreditation by PSRBs: RQ3}

In the UK as in most jurisdictions, higher education provision addresses general computer science and specialist cybersecurity courses. A significant number of undergraduate and postgraduate programmes are available in both the areas of computer science and cybersecurity (and closely related fields computer security, digital/computer forensics, etc). In the UK, the Universities and Colleges Admissions Service (UCAS) lists over 40 higher education institutions (HEIs) providing undergraduate qualifications related to cybersecurity for entry in September 2019. An even larger number of HEIs provide study opportunities related to more general computer science. UCAS lists 246 provides for undergraduate programmes related to computer science. 
